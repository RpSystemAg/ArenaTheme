...
<div class="arena-gallery-snap wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="arena-gallery-snap__head wp-block-group">
		...
		<div class="arena-carousel__controls wp-block-group">
			<!-- wp:button {"className":"arena-gallery-snap__control arena-carousel__control","text":"Previous"} -->
			<div class="wp-block-button"><a class="wp-block-button__link arena-gallery-snap__control arena-carousel__control wp-element-button" data-arena-carousel-prev href="#">Previous</a></div>
			<!-- /wp:button -->
			<!-- wp:button {"className":"arena-gallery-snap__control arena-carousel__control","text":"Next"} -->
			<div class="wp-block-button"><a class="wp-block-button__link arena-gallery-snap__control arena-carousel__control wp-element-button" data-arena-carousel-next href="#">Next</a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:group -->
	</div>
