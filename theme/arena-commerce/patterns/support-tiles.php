...
<div class="arena-support-tiles wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)" data-arena-pattern="support-tiles" data-arena-family="Support" data-arena-module="support-tile-grid">
	...
	<span aria-hidden="true" class="arena-support-tiles__support-tile-card" data-arena-role="support-tile-card"></span>
</div>
<!-- /wp:group -->
