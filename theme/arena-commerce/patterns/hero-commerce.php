...
<div class="arena-hero wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="arena-hero__columns wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:52%">
			...
			<p class="arena-hero__eyebrow is-style-arena-eyebrow has-accent-color has-text-color has-xs-font-size" style="font-weight:600;letter-spacing:0.14em;text-transform:uppercase">New season · Free returns</p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"textAlign":"left","level":1,"className":"arena-hero__title","fontSize":"6xl","style":{"typography":{"letterSpacing":"-0.035em"}}} -->
			<h1 class="arena-hero__title has-text-align-left wp-block-heading has-6xl-font-size" style="letter-spacing:-0.035em">Equipment that keeps up with you</h1>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:48%">
			...
			<figure class="arena-hero__media is-style-arena-frame wp-block-image size-arena-card-lg"><img src="" alt="Athlete wearing the Arena shell jacket on a mountain ridge at sunrise" style="aspect-ratio:4/5;object-fit:cover" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	</div>
